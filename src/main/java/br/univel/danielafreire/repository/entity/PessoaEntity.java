package br.univel.danielafreire.repository.entity;
...
/*
 * Classe entidade pessoa com seus atributos, getters e setters
 */
public class PessoaEntity {
	...
	//um-para-um somente um ID exclusivo para cada usuario
	@OneToOne
